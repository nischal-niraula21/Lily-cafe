...
export default function Home() {
  ...
  return <main>
    <section className="hero hero-v3"><div className="hero-media"><img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=2400&q=92" alt="Warm restaurant interior"/></div><div className="container hero-content"><div className="eyebrow">Welcome to Lily Cafe & Restaurant</div><h1 className="display h1">A Place Made for<br/><span className="gold">Good Food</span> &amp;<br/>Beautiful Moments</h1><p className="hero-copy">Warm food, thoughtful service and private spaces for the moments you actually want to remember.</p><div className="hero-actions"><Link className="btn btn-gold btn-arrow" to="/menu">Explore Our Menu</Link><Link className="btn btn-ghost btn-arrow" to="/cabins">Book Cabin</Link></div></div></section>

    <section className="why-us-section"><div className="container why-us-grid"><div className="why-us-intro reveal"><div className="eyebrow">Why us</div><h2 className="display h3">The small details make the whole evening feel better.</h2><p>Nothing loud or over-designed - just good food, privacy when you want it and a warm room that lets you settle in.</p></div><div className="why-us-list reveal">
      <article className="why-us-item"><span className="why-icon"><FoodIcon/></span><div><h3>Thoughtful Food</h3><p>Comforting dishes, prepared with care and served without fuss.</p></div></article>
